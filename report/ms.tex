...
\begin{enumerate}
\item Order the the light curve measurements in time i.e. $\{(t_1,m_1,e_1),(t_2,m_2,e_2), \ldots , (t_l,m_l,e_l)\}$ where $t_i < t_j$ for $i < j$.
\item Sliced each light curve into 5 contiguous sections, producing 5 time series. Slice 1 is $(t_i,m_i,e_i)$ for $\frac{0}{10}l \leq i \leq \frac{5}{10}l$, slice 2 is $\frac{1}{10}l \leq i \leq \frac{6}{10}l$, ect.
%% \begin{enumerate}
